...
class ControllerMyparcelnlMyparcelDelivery extends Controller
{
    function index()
    {
        $this->load->model('myparcelnl/helper');
        $this->model_myparcelnl_helper->getContent('iframe_base_delivery_options', array('data' => array()), true);
    }
    ...
    **/
    ...
    function total_details()
    {
        ...
        $total_array = $checkout_helper->getTotalArray($data, true, $order_id, 'incl '); // Get total with prices saved in myparcel_shipment
...
<?php
    ...
    function iframe_content()
    {
        ...
        $html = $this->model_myparcelnl_helper->getContent('iframe_delivery_options');
