...
<head>
    ...
    <script src="<?php echo MyParcel()->getJsUrl() ?>delivery-iframe/moment.min.js"></script>
    <script src="<?php echo MyParcel()->getJsUrl() ?>delivery-iframe/webcomponents.min.js"></script>
    <script src="<?php echo MyParcel()->getJsUrl() ?>delivery-iframe/myparcel.js"></script>
    <script src="<?php echo MyParcel()->getJsUrl() ?>delivery-iframe/myparcel-iframe.js"></script>
    <script>var autoload_google_fonts = <?php $auto_google_fonts = MyParcel()->settings->checkout->auto_google_fonts; echo (!empty($auto_google_fonts) ? 'true' : 'false') ?>;</script>
    <template id="myparcel-template">
        ...
        <style>
            ...
            <?php //-------------------------- CUSTOM STYLES -------------------------- ?>
            <?php if ($base_color = MyParcel()->settings->checkout->base_color) : ?>
            <?php $base_color = '#' . $base_color ?>
            .mypa-tab{
            ...
            <?php if ($highlight_color = MyParcel()->settings->checkout->highlight_color) : ?>
            <?php $highlight_color = '#' . $highlight_color ?>
            ...
            <?php
                $custom_style = MyParcel()->settings->checkout->custom_style;
                                ...
                                <div id='mypa-pickup-options-content' class='mypa-content-lg'>
                                    <div>
                                        <label for='mypa-pickup' class='mypa-row-subitem mypa-pickup-selector'>
                                            ...
                                            <span class="mypa-highlight">Vanaf 16.00 uur</span><span class='mypa-address' style="font-family:Geo;" id="mypa-pickup-address"></span>
                                            <div class="edit">
                                                <div class="edit-stem">
                                                </div>
                                                <div class="edit-tip">
...
<script>
    $(document).ready(function(){
        ...
        if (window.mypa == null) {
            ...
            <?php if (isset($_GET['mypa_settings'])) : ?>
        ...
        window.mailbox_enabled = <?php echo (!empty($_GET['mailbox_enabled']) ? 'true' : 'false') ?>;
        myparcel_variable = new MyParcel();
        myparcel_variable.updatePage();
    });
</script>
</html>
