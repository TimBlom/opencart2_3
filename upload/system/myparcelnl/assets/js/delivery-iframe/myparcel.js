...
(function() {
    ...
    this.MyParcel = Application = (function() {
        ...
        function Application(options) {
            ...
            this.expose(this.hideLoading, 'hideLoading');
            this.expose(this.resetForm, 'resetForm');
            this.expose(this.activateForm, 'activateForm');
        ...
        Application.prototype.bindInputListeners = function() {
            ...
            return externalJQuery('#mypa-input', parent.document).on('change', (function(_this) {
                return function(e) {
                    var deliveryActive, el, i, json, len, ref;
                    json = externalJQuery('#mypa-input', parent.document).val();
    ...
    renderPage = function(response) {
        ...
        $('#mypa-delivery-options-title').on('click', function() {
            ...
            // Custom code
            window.parent.window.MYPARCEL_CHECKOUT.eventActivated();
        ...
        $('#mypa-mailbox-location').on('change', function () {
            if ($(this).is(':checked')) {
                ...
                $('.mypa-mailbox-price').toggleClass('mypa-price-active', true);
            } else {
                parent.mypajQuery('#mypa-input').val('{}').trigger('change');
                $('.mypa-mailbox-price').toggleClass('mypa-price-active', false);
            }
        });
        // End custom code
    ...
    updateInputField = function() {
        ...
        if (window.mypa.settings.cc === NATIONAL) {
            if (externalJQuery('#mypa-signed', parent.document).prop('checked') !== $('#mypa-signed').prop('checked')) {
                externalJQuery('#mypa-signed', parent.document).prop('checked', $('#mypa-signed', parent.document).prop('checked'));
                externalJQuery('#mypa-signed', parent.document).trigger('change');
                hasChanged = true;
            }
            ...
            if (externalJQuery('#mypa-recipient-only', parent.document).prop('checked') !== $('#mypa-only-recipient').prop('checked')) {
                ...
                externalJQuery('#mypa-recipient-only', parent.document).trigger('change');
                hasChanged = true;
            }
        } else {
            deliveryEl = $('#mypa-delivery-option-check');
            if (deliveryEl.prop('checked')) {
                json = deliveryEl.val();
            }
        }

        if (externalJQuery('#mypa-input', parent.document).val() !== json || hasChanged) {

            externalJQuery('#mypa-input', parent.document).val(json);
            parent.$("#mypa-input").trigger("change");
            //return externalJQuery('#mypa-input', parent.document).trigger('change');
        }
    };
